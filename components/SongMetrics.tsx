...
export default function SongMetrics({ song, lyrics, onBack, showBackButton = false, onSelectSong }: Props) {
  ...
  const renderCalendar = () => {
    ...
    return (
      <div className="bg-base-100 backdrop-blur-xs border border-base-300 rounded-2xl p-4 md:p-6 shadow-lg shadow-purple-500/10">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-1 h-6 bg-linear-to-b from-purple-500 to-pink-500 rounded-full" />
          <h3 className="text-lg md:text-xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">{monthName}</h3>
        </div>
            ...
            return (
              <button
                ...
                className={`p-1 md:p-2 text-xs md:text-sm rounded-xl transition-all duration-300 ${
                  isCompleted
                    ? 'bg-linear-to-br from-green-500 to-emerald-600 text-white font-bold shadow-lg shadow-green-500/50 scale-110'
                    : isToday
                    ? 'bg-linear-to-br from-blue-100 to-indigo-100 text-blue-800 font-semibold border-2 border-blue-300'
  ...
  if (loading) {
    return (
      <div className="bg-base-100 backdrop-blur-xs rounded-2xl shadow-lg shadow-purple-500/10 border border-base-300 p-4 md:p-6">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-1 h-8 bg-linear-to-b from-purple-500 to-pink-500 rounded-full" />
          <h2 className="text-xl md:text-2xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Song Metrics</h2>
        </div>
        <div className="text-center py-12">
    ...
    <div className="bg-base-100 shadow-lg border border-base-300 p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
        <div className="group bg-linear-to-br from-emerald-50 to-green-50 border border-emerald-200/50 rounded-2xl p-4 md:p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-emerald-500/20 hover:-translate-y-1">
          ...
          <div className="text-2xl md:text-3xl font-bold bg-linear-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">
        ...
        <div className="group bg-linear-to-br from-purple-50 to-pink-50 border border-purple-200/50 rounded-2xl p-4 md:p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/20 hover:-translate-y-1">
          ...
          <div className="text-2xl md:text-3xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
        ...
        <div className="group bg-linear-to-br from-blue-50 to-indigo-50 border border-blue-200/50 rounded-2xl p-4 md:p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 hover:-translate-y-1">
          ...
          <div className="text-2xl md:text-3xl font-bold bg-linear-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">{sessions.length}</div>
        ...
        <div className="group bg-linear-to-br from-green-50 to-emerald-50 border border-green-200/50 rounded-2xl p-4 md:p-6 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-green-500/20 hover:-translate-y-1">
          ...
          <div className="text-2xl md:text-3xl font-bold bg-linear-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">{getTotalTakes()}</div>
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-1 h-6 bg-linear-to-b from-purple-500 to-pink-500 rounded-full" />
          <h3 className="text-lg md:text-xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Takes Per Line</h3>
        </div>
        <div className="bg-base-100 backdrop-blur-xs border border-base-300 rounded-2xl p-4 shadow-lg shadow-purple-500/10">
          {lyrics.length === 0 ? (
                    ...
                    <div key={line._id} className="group flex flex-col md:flex-row md:items-center gap-2 p-3 bg-base-100 rounded-xl border border-base-300 hover:shadow-md transition-all duration-300">
                      ...
                      <div className="flex items-center gap-2 md:w-48">
                        <div className="flex-1 bg-base-300 rounded-full h-3 overflow-hidden">
                          <div
                            className="bg-linear-to-r from-purple-500 to-pink-500 h-3 rounded-full transition-all duration-500 ease-out shadow-inner"
                            style={{ width: `${percentage}%` }}
                          />
                        </div>
                        <span className="text-xs md:text-sm font-bold bg-purple-100 text-purple-700 px-2 py-1 rounded-lg min-w-8 text-center">
                          {takes}
                        </span>
                      </div>
                    </div>
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-1 h-6 bg-linear-to-b from-purple-500 to-pink-500 rounded-full" />
          <h3 className="text-lg md:text-xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Practice Time Trend</h3>
        </div>
        <div className="bg-base-100 backdrop-blur-xs border border-base-300 rounded-2xl p-4 shadow-lg shadow-purple-500/10">
          {sessions.length === 0 ? (
            <div className="text-center py-8">
      ...
      <div>
        <div className="flex items-center gap-3 mb-4">
          <div className="w-1 h-6 bg-linear-to-b from-purple-500 to-pink-500 rounded-full" />
          <h3 className="text-lg md:text-xl font-bold bg-linear-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Practice History</h3>
        </div>
        <div className="bg-white/70 backdrop-blur-xs border border-slate-200/50 rounded-2xl p-4 max-h-48 md:max-h-64 overflow-y-auto shadow-lg shadow-purple-500/10">
          {sessions.length === 0 ? (
            <div className="text-center py-8">
              <svg className="w-12 h-12 text-base-content/30 mx-auto mb-3" fill="none" stroke="currentColor" strokeWidth="1" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
              ...
              {sessions.map(session => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    {session.completed && (
                      <span className="px-3 py-1 bg-linear-to-r from-green-100 to-emerald-100 text-green-700 rounded-xl text-xs font-semibold border border-green-200/50">
                        ✓ Completed
                      </span>
                    )}
                  </div>
