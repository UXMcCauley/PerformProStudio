        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4">
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 px-3 py-2 transition-all duration-200 disabled:cursor-not-allowed ${
                lyricsCount === 0
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-2 p-1 hover:bg-purple-50 transition-all duration-200 rounded-full"
              title="Profile"
            >
            ...
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-64 bg-base-100 shadow-xl border border-base-300 py-2 z-50">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 text-left text-sm text-base-content hover:bg-purple-50 transition-colors flex items-center gap-2"
                >
